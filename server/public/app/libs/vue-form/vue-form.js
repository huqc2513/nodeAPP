    ...
    vueForm.install = function (Vue) {
        ...
        var validators = {
            ...
            email: function (value, multiple) {
                return emailRegExp.test($.trim(value));
            },
            number: function (value) {
                return !isNaN(value);
            },
            url: function (value) {
                return urlRegExp.test($.trim(value));
            },
            ...
            pattern: function (value, pattern) {
                ...
                return patternRegExp.test($.trim(value));
            },
        ...
        Vue.directive('formCtrl', {
            ...
            bind: function () {
                var inputName = this.el.getAttribute('name'),
                    ...
                    onBlur=this.el.getAttribute('on-blurs'),
                    vm = this.vm,
                    el = this.el,
                    self = this,
                    scope, objectBinding;
                ...
                var vueFormCtrl = el._vueFormCtrl = self._vueFormCtrl = {
                    ...
                    setTouched: function (isTouched) {                        
                        ...
                        if(onBlur){
                            var blurs=scope.$eval(onBlur);
                            blurs.call(this,el,isTouched);
                        }
                        Vue.util.addClass(el, touchedClass);
                        Vue.util.removeClass(el, untouchedClass); 
                    },       
